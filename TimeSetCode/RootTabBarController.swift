...
class RootTabBarController: UITabBarController {
    ...
    fileprivate func creatSubViewCtrs(){
        ...
        //1.
        let oneVC = storyboard.instantiateViewController(withIdentifier: "ViewController")
        ...
        one.navigationBar.barTintColor = UIColor(red: 89/255.0, green: 161/255.0, blue: 45/255.0, alpha: 1)
        
        
        one.tabBarItem = UITabBarItem(title: "Home", image: UIImage(named: "homeA")?.withRenderingMode(.alwaysOriginal), selectedImage: UIImage(named: "homeL")?.withRenderingMode(.alwaysOriginal))
        
        
        
        //2.
        let towVC = ViewController()
        ...
        tow.tabBarItem = UITabBarItem(title: "BucketList", image: UIImage(named: "reportA")?.withRenderingMode(.alwaysOriginal), selectedImage: UIImage(named: "reportL")?.withRenderingMode(.alwaysOriginal))
        ...
        three.tabBarItem = UITabBarItem(title: "Notifications", image: UIImage(named: "messageA")?.withRenderingMode(.alwaysOriginal), selectedImage: UIImage(named: "messageL")?.withRenderingMode(.alwaysOriginal))
        //4.
        let fourVC = ViewController()
        ...
        four.tabBarItem = UITabBarItem(title: "Profile", image: UIImage(named: "shopA")?.withRenderingMode(.alwaysOriginal), selectedImage: UIImage(named: "shopL")?.withRenderingMode(.alwaysOriginal))
        //添加到控制器数组
